...
bboxes.onAdd("Image", function(index, cls, params) {
    var bbox = {"rect": paper.rect(params.x, params.y, params.width, params.height)
			     .attr({"stroke": classes[cls].color,
    				    "stroke-width": 3})};
...
function addEventsToImage() {
	...
	function(x, y, e) {
		...
		case "add":
		    ...
		    drawingRect.attr({stroke: classes.target().color,
				      "stroke-width": 3});
